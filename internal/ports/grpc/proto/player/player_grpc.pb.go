...
const (
	...
	Player_GetPlayerById_FullMethodName = "/player.Player/GetPlayerById"
)
...
func (c *playerClient) CreatePlayer(ctx context.Context, in *CreatePlayerRequest, opts ...grpc.CallOption) (*CreatePlayerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Player_CreatePlayer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playerClient) GetPlayerById(ctx context.Context, in *GetPlayerByIdRequest, opts ...grpc.CallOption) (*GetPlayerByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, Player_GetPlayerById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Player_GetPlayerById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Player_GetPlayerById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Player_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/ports/grpc/proto/player/player.proto",
}
