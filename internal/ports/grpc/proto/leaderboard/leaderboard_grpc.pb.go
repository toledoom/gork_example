...
const (
	...
	Leaderboard_GetTopPlayers_FullMethodName = "/leaderboard.Leaderboard/GetTopPlayers"
)
...
func (c *leaderboardClient) GetTopPlayers(ctx context.Context, in *GetTopPlayersRequest, opts ...grpc.CallOption) (*GetTopPlayersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Leaderboard_GetTopPlayers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Leaderboard_GetTopPlayers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Leaderboard_GetTopPlayers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Leaderboard_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/ports/grpc/proto/leaderboard/leaderboard.proto",
}
